...
##print("Muutaja",vanus,"on",type(vanus))
##print("Muutaja",eesnimi,"on",type(eesnimi))
##print("Muutaja",pikkus,"on",type(pikkus))
##print("Muutaja",kas_käib_koolis,"on",type(kas_käib_koolis))
